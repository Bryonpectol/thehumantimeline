const events = [
  ...
  {"year":"2011","time":"A.D.","image":"","events":"1: Osama bin Laden, the founder and leader of al-Qaeda, is killed by United States forces in Pakistan. 2: The Syrian Civil War begins, leading to a complex and ongoing conflict with significant humanitarian consequences."},
  {"year":"2010","time":"A.D.","image":"","events":"The Arab Spring movement begins, with widespread protests and uprisings taking place across the Middle East and North Africa."},
  {"year":"2008","time":"A.D.","image":"","events":"The global financial crisis begins with the collapse of Lehman Brothers, leading to a worldwide economic downturn."},
  {"year":"2004","time":"A.D.","image":"","events":"The Indian Ocean earthquake and tsunami occur, resulting in the deaths of hundreds of thousands of people in multiple countries."},
  {"year":"2003","time":"A.D.","image":"","events":"The United States and its allies invade Iraq, leading to the overthrow of Saddam Hussein's regime."},
  {"year":"2001","time":"A.D.","image":"","events":"September 11 attacks take place in the United States, resulting in the destruction of the World Trade Center towers and leading to global efforts to combat terrorism."},
  {"year":"1991","time":"A.D.","image":"","events":"The Soviet Union dissolves, leading to the emergence of independent countries in its place."},
  {"year":"1989","time":"A.D.","image":"","events":"The fall of the Berlin Wall marks the beginning of the reunification of East and West Germany."},
  {"year":"1969","time":"A.D.","image":"","events":"The United States successfully lands astronauts on the moon during the Apollo 11 mission."},
  {"year":"1961-1989","time":"A.D.","image":"","events":"The Berlin Wall is constructed, dividing East and West Berlin, symbolizing the division between Eastern and Western blocs during the Cold War."},
  {"year":"1950-1953","time":"A.D.","image":"","events":"The Korean War takes place between North Korea, supported by China and the Soviet Union, and South Korea, supported by a United Nations coalition led by the United States."},
  {"year":"1947","time":"A.D.","image":"","events":"India and Pakistan gain independence from British colonial rule."},
  {"year":"1947-1991","time":"A.D.","image":"","events":"The Cold War begins, a period of political tension and ideological rivalry between the United States and the Soviet Union."},
  {"year":"1945","time":"A.D.","image":"","events":"The United Nations is founded with the goal of promoting international cooperation and preventing future conflicts."},
  {"year":"1939-1945","time":"A.D.","image":"","events":"World War II takes place, involving numerous countries and resulting in the Holocaust, widespread devastation, and the use of atomic weapons."},
  {"year":"1929","time":"A.D.","image":"","events":"The Wall Street Crash occurs, marking the beginning of the Great Depression, a severe worldwide economic downturn."},
  {"year":"1918","time":"A.D.","image":"","events":"World War I ends with the signing of the Armistice, leading to significant political and territorial changes."},
  {"year":"1917","time":"A.D.","image":"","events":"The Russian Revolution occurs, leading to the establishment of the Soviet Union."},
  {"year":"1914-1918","time":"A.D.","image":"","events":"World War I takes place, involving many nations and resulting in significant casualties and territorial changes."},
  {"year":"1901","time":"A.D.","image":"","events":"Queen Victoria of the United Kingdom passes away, and her son Edward VII ascends to the throne."},
  {"year":"1898","time":"A.D.","image":"","events":"The Spanish-American War takes place, resulting in the United States acquiring territories such as Puerto Rico, Guam, and the Philippines."},
  {"year":"1893","time":"A.D.","image":"","events":"New Zealand becomes the first country in the world to grant women the right to vote in national elections."},
  {"year":"1885","time":"A.D.","image":"","events":"The Berlin Conference takes place, where European powers divide Africa into colonies, leading to the Scramble for Africa."},
  {"year":"1871","time":"A.D.","image":"","events":"The German Empire is established after the Prussian victory in the Franco-Prussian War, with Wilhelm I of Prussia becoming the first German Emperor."},
  {"year":"1861-1865","time":"A.D.","image":"","events":"The American Civil War takes place, a conflict between the Northern states (Union) and the Southern states (Confederacy) over issues including slavery and states' rights."},
  {"year":"1859","time":"A.D.","image":"","events":"Charles Darwin publishes 'On the Origin of Species', presenting the theory of evolution through natural selection."},
  {"year":"1848","time":"A.D.","image":"","events":"The Revolutions of 1848 sweep across Europe, marked by widespread uprisings and demands for political and social reform."},
  {"year":"1833","time":"A.D.","image":"","events":"The Slavery Abolition Act is passed in the British Empire, abolishing slavery throughout most of the British colonies."},
  {"year":"1830","time":"A.D.","image":"","events":"The July Revolution in France leads to the overthrow of King Charles X and the establishment of the July Monarchy under King Louis-Philippe."},
  {"year":"1815","time":"A.D.","image":"","events":"The Battle of Waterloo takes place, resulting in the defeat of Napoleon Bonaparte and the end of the Napoleonic Wars."},
  {"year":"1807","time":"A.D.","image":"","events":"The British Parliament passes the Slave Trade Act, abolishing the slave trade throughout the British Empire."},
  {"year":"1804","time":"A.D.","image":"","events":"Napoleon Bonaparte crowns himself Emperor of the French, establishing the First French Empire."},
  ...
  {"year":"1707","time":"A.D.","image":"","events":"The Act of Union is passed, merging the Kingdom of England and the Kingdom of Scotland to form the Kingdom of Great Britain."},
  {"year":"1701","time":"A.D.","image":"","events":"The War of the Spanish Succession begins, triggered by disputes over the Spanish throne."},
  {"year":"1689","time":"A.D.","image":"","events":"The Bill of Rights is passed in England, guaranteeing certain civil liberties and establishing the supremacy of Parliament."},
  {"year":"1688-1689","time":"A.D.","image":"","events":"The Glorious Revolution in England takes place, resulting in the overthrow of King James II and the establishment of a constitutional monarchy under William III and Mary II."},
  {"year":"1666","time":"A.D.","image":"","events":"The Great Fire of London devastates the city, destroying much of the medieval city and prompting significant urban redevelopment."},
  {"year":"1665-1666","time":"A.D.","image":"","events":"The Great Plague of London occurs, causing a significant loss of life and impacting the city's population and economy."},
  {"year":"1642-1651","time":"A.D.","image":"","events":"The English Civil War is fought between the Royalists, supporting King Charles I, and the Parliamentarians, resulting in the temporary overthrow of the monarchy and the establishment of the Commonwealth of England under Oliver Cromwell."},
  {"year":"1620","time":"A.D.","image":"","events":"The Mayflower, carrying English Pilgrims seeking religious freedom, arrives in Plymouth, Massachusetts, marking the establishment of the Plymouth Colony."},
  {"year":"1618-1648","time":"A.D.","image":"","events":"The Thirty Years' War takes place in Europe, involving multiple conflicts between various European powers and resulting in significant political and religious realignments."},
  {"year":"1607","time":"A.D.","image":"","events":"The English establish the Jamestown colony in Virginia, marking the first permanent English settlement in North America."},
  {"year":"1603","time":"A.D.","image":"","events":"The Tokugawa shogunate begins in Japan, establishing a centralized feudal government that will last for over 250 years."},
  {"year":"1598","time":"A.D.","image":"","events":"King Henry IV of France issues the Edict of Nantes, granting religious toleration to French Protestants (Huguenots)."},
  {"year":"1596-1597","time":"A.D.","image":"","events":"William Shakespeare's play 'Romeo and Juliet' is performed for the first time, becoming one of his most renowned works."},
  {"year":"1588","time":"A.D.","image":"","events":"The Spanish Armada, a fleet sent by King Philip II of Spain, is defeated by the English navy, marking a significant turning point in European naval warfare and English supremacy."},
  {"year":"1543","time":"A.D.","image":"","events":"Nicolaus Copernicus publishes 'De Revolutionibus Orbium Coelestium', proposing the heliocentric model of the solar system."},
  {"year":"1533","time":"A.D.","image":"","events":"Henry VIII of England separates from the Roman Catholic Church and establishes the Church of England, with himself as the head, in order to obtain an annulment from his first marriage."},
  {"year":"1519-1522","time":"A.D.","image":"","events":"Ferdinand Magellan's expedition becomes the first to circumnavigate the globe, although Magellan himself dies during the journey."},
